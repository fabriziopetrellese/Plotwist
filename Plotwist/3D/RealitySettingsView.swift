    ...
    var body: some View{
        ScrollView {
            LazyVGrid(columns: gridItemLayout, spacing: 25) {
                ...
                SettingToggleButton(setting: .peopleOcclusion, isOn: $sessionSetting.isPeopleOcclusionEnabled)
                SettingToggleButton(setting: .objectOcclusion, isOn: $sessionSetting.isObjectOcclusionEnabled)
